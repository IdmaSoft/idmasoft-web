            ...
            <div className="flex justify-center lg:justify-end">
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-4 w-full max-w-sm">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium text-slate-400">{t("statusCard.statusLabel")}</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium text-slate-400">{t("statusCard.categoryLabel")}</span>
                  <span className="text-sm text-white">{t("statusCard.category")}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium text-slate-400">{t("statusCard.platformLabel")}</span>
                  <span className="text-sm text-white">{t("statusCard.platform")}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium text-slate-400">{t("statusCard.developerLabel")}</span>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <h2 className="text-xl font-bold text-slate-900 mb-3">{t("problem.title")}</h2>
            ...
            <div>
              ...
              <h2 className="text-xl font-bold text-slate-900 mb-3">{t("solution.title")}</h2>
              <p className="text-slate-500 leading-relaxed text-sm">
            ...
            <div>
              ...
              <h2 className="text-xl font-bold text-slate-900 mb-3">{t("result.title")}</h2>
              <p className="text-slate-500 leading-relaxed text-sm">
